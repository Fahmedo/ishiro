...
export default function MiniDashboard() {
  return (
    <motion.div className="relative" variants={fadeInUp}>
      ...
      <motion.div
        className="bg-white text-black rounded-2xl shadow-2xl overflow-hidden border border-gray-100"
        animate={{ y: [0, -10, 0] }}
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          >
            <h4 className="text-sm font-semibold  mb-4">Spending Trend</h4>
      ...
      {/* Floating Badge */}
      <motion.div
        className="absolute -bottom-7 -right-4 bg-secondary text-secondary-foreground px-4 py-2 rounded-full text-sm font-semibold shadow-lg"
        animate={{ y: [0, -8, 0] }}
